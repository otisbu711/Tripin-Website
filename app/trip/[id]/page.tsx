    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-16 relative">
      ...
      <div className="relative z-10 w-full max-w-sm mx-auto flex flex-col items-center text-center gap-6">
        ...
        <div className="flex items-center gap-2 mb-2">
          <span className="font-serif italic text-4xl tracking-tight text-foreground">tripin</span>
          <Image src="/pin.png" alt="" width={28} height={36} />
        </div>
        ...
        <div className="flex flex-col gap-3 w-full mt-2">
          <OpenInAppButton tripId={id} />

          <a
            href="https://apps.apple.com/app/tripin/id6780014125"
            className="w-full flex items-center justify-center gap-3 bg-foreground text-background font-sans font-medium text-base py-4 rounded-brand hover:opacity-80 transition-opacity"
          >
