  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-5">
      ...
      <a href="/" className="relative flex items-center gap-2">
        ...
        <img src="/pin.png" alt="" aria-hidden="true" className="w-5 h-7 object-contain mt-0.5" />
      </a>
      ...
      <div className="relative flex items-center gap-8">
        ...
        <a href="/contact" className="font-sans text-sm text-muted hover:text-foreground transition-colors">
          Contact
        </a>
        <a
          href="/#download"
